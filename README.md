This repository contains all the codes and dataset used in the *MSR 2022* technical track paper ***'Does Configuration Encoding Matter in Learning Software Performance? An Empirical Study on Encoding Schemes'*** by Jingzhi Gong and Tao Chen. 
